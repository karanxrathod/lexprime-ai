...
const AppShell: React.FC<AppShellProps> = ({
  ...
  const navItems: NavItem[] = [
    ...
    { id: "pricing", label: t.pricing, icon: <CreditCard className="h-5 w-5" /> },
  ];
    ...
    <div className="w-screen h-screen flex flex-col md:flex-row bg-premium-gradient overflow-hidden">
      ...
      <div className="md:hidden h-14 border-b border-border bg-background/80 backdrop-blur flex items-center justify-between px-3 shrink-0 z-20">
        <div className="flex items-center gap-2">
          ...
          <img src="/logo.png" alt="LexPrime AI" className="h-8 w-8 object-contain" />
        ...
        <div className={`h-16 flex items-center px-4 border-b border-border ${isSidebarCollapsed ? 'justify-center' : 'justify-between'} shrink-0`}>
          {!isSidebarCollapsed ? (
            <div className="flex items-center gap-2 overflow-hidden whitespace-nowrap">
              <img src="/logo.png" alt="LexPrime AI" className="h-10 w-10 object-contain shrink-0" />
              <div className="leading-tight">
            ...
            <img src="/logo.png" alt="LexPrime AI" className="h-10 w-10 object-contain" />
          )}
        </div>
              ...
              {isLanguageDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-40 bg-popover border border-border rounded-xl shadow-xl z-50 overflow-hidden">
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 text-sm hover:bg-accent hover:text-accent-foreground transition-colors flex items-center justify-between ${language === 'en' ? 'bg-secondary text-secondary-foreground font-medium' : 'text-foreground'
                      }`}
                  >
                    <span>English</span>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 text-sm hover:bg-accent hover:text-accent-foreground transition-colors flex items-center justify-between ${language === 'hi' ? 'bg-secondary text-secondary-foreground font-medium' : 'text-foreground'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 text-sm hover:bg-accent hover:text-accent-foreground transition-colors flex items-center justify-between ${language === 'mr' ? 'bg-secondary text-secondary-foreground font-medium' : 'text-foreground'
                      }`}
                  >
                    <span>मराठी (Marathi)</span>
                    {language === 'mr' && <span className="text-primary">✓</span>}
                  </button>
                </div>
              )}
            </div>
              ...
              <div className="mt-3 pt-3 border-t border-border">
                ...
                <div className="space-y-1">
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors border flex items-center justify-between ${language === 'en'
                      ? 'bg-secondary text-secondary-foreground border-border'
                      : 'bg-background text-foreground hover:bg-accent border-transparent'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors border flex items-center justify-between ${language === 'hi'
                      ? 'bg-secondary text-secondary-foreground border-border'
                      : 'bg-background text-foreground hover:bg-accent border-transparent'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors border flex items-center justify-between ${language === 'mr'
                      ? 'bg-secondary text-secondary-foreground border-border'
                      : 'bg-background text-foreground hover:bg-accent border-transparent'
                      }`}
                  >

      ...
      generateContent: vi.fn().mockImplementation(async (req: any) => {
        ...
        if (promptText.includes('User Question:')) {
          return {
            response: {
              text: () =>
                'Under Section 4 of the uploaded agreement, the notice period required is 30 days prior to contract termination. Disclaimer: AI-generated information is for informational purposes and does not constitute legal advice.',
            },
          };
        }

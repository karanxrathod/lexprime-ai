...
const AnalysisResults: React.FC<AnalysisResultsProps> = ({
  ...
  const sections = [
    { id: "summary", label: t.plainSummary },
    { id: "authenticity", label: t.authenticityTab },
    { id: "clauses", label: t.clauseLens },
    { id: "risks", label: t.riskRadar },
    { id: "negotiation", label: t.negotiation },
    { id: "actions", label: t.actionPoints },
    { id: "citations", label: t.citations },
  ];

  // Scroll Spy Effect
  // Scroll spy removed in favor of direct tab navigation
...
`;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Content */}
      <div id="content-container" className="bg-white/30 dark:bg-slate-900/30 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-slate-700/30 overflow-hidden min-h-[500px]">
        {activeSection === "summary" && (
          <div id="summary" className="p-6 border-b border-white/10 dark:border-slate-700/30 animate-in fade-in duration-300">
                ...
                {analysis.authenticity && (
                  <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/20 dark:border-slate-700/30 shadow-xl">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className={`h-12 w-12 rounded-full flex items-center justify-center ${analysis.authenticity.authenticityScore >= 80 ? 'bg-green-100 text-green-600' : 'bg-amber-100 text-amber-600'
                        }`}>
        ...
        {activeSection === "authenticity" && (
          <div id="authenticity" className="p-8 border-b border-white/10 dark:border-slate-700/30 animate-in fade-in duration-300">
            {analysis.authenticity ? (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm p-6 rounded-2xl border border-white/20 dark:border-slate-700/30 shadow-lg">
                    <div className="flex justify-between items-center mb-4">
                      <h4 className="font-semibold text-gray-900 dark:text-slate-100">{t.authScore}</h4>
                  ...
                  <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm p-6 rounded-2xl border border-white/20 dark:border-slate-700/30 shadow-lg">
                    <div className="flex justify-between items-center mb-4">
                      <h4 className="font-semibold text-gray-900 dark:text-slate-100">{t.safeScore}</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-6">
                    <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm border border-white/20 dark:border-slate-700/30 rounded-2xl p-6 shadow-lg">
                      ...
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <span className="text-lg font-medium text-gray-800 dark:text-slate-200">
                          {analysis.authenticity.isCompliant ? t.compliant : t.potentialIssues}
                        </span>
                      </div>
                      <p className="text-sm text-gray-600 dark:text-slate-400">
                        {t.evaluatedAgainst}: <span className="font-medium">{analysis.authenticity.compliantWith}</span>
                      </p>
                    </div>
                    ...
                    <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm border border-white/20 dark:border-slate-700/30 rounded-2xl p-6 shadow-lg">
                      ...
                      <div className="flex items-center space-x-3">
                        <div className={`px-3 py-1 rounded-full text-sm font-bold border ${analysis.authenticity.fakeIndication === 'High' ? 'bg-red-100 text-red-700 border-red-200' :
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-gray-600 dark:text-slate-400">{t.runningAuth}</p>
              </div>
            )}
          </div>
        )}
        ...
        {activeSection === "clauses" && (
          <div id="clauses" className="p-8 space-y-4 border-b border-white/10 dark:border-slate-700/30 animate-in fade-in duration-300">
            <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-6">
              {t.clauseLens}
            </h3>
        ...
        {activeSection === "risks" && (
          <div id="risks" className="p-8 border-b border-white/10 dark:border-slate-700/30 animate-in fade-in duration-300">
            <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-6">
              {t.riskRadar}
            </h3>
                ...
                analysis.risks.map((risk) => (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      <div
                        className={`p-2 rounded-lg ${risk.severity === 'high' ? 'bg-red-50 text-red-700' : risk.severity === 'medium' ? 'bg-amber-50 text-amber-700' : 'bg-green-50 text-green-700'
                          }`}
                      >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span
                            className={`px-2 py-1 rounded text-xs font-medium ${risk.severity === 'high' ? 'bg-red-50 text-red-700' : risk.severity === 'medium' ? 'bg-amber-50 text-amber-700' : 'bg-green-50 text-green-700'
                              }`}
                          >
                            {{
                              low: t.severityLow,
        ...
        {activeSection === "negotiation" && (
          <div id="negotiation" className="p-8 border-b border-white/10 dark:border-slate-700/30 animate-in fade-in duration-300">
        ...
        {activeSection === "actions" && (
          <div id="actions" className="p-8 border-b border-white/10 dark:border-slate-700/30 animate-in fade-in duration-300">
            <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-6">
              {t.actionPoints}
            </h3>
        ...
        {activeSection === "citations" && (
          <div id="citations" className="p-8 border-b border-white/10 dark:border-slate-700/30 animate-in fade-in duration-300">
            <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-6">
              {t.citations}
            </h3>
            <div className="space-y-4">

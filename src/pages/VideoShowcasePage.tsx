  ...
  const videoSlides: VideoSlide[] = [
    {
      ...
      description: "See how LexPrime AI transforms complex legal documents into easy-to-understand summaries with our AI-powered analysis engine.",
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base">
                  Watch how LexPrime AI simplifies legal document analysis
                </p>
              </div>
              <button
                onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {videoSlides.map((slide, index) => (
                <button
                  key={slide.id}
                  onClick={() => goToSlide(index)}
                  className={`text-left p-4 rounded-lg border-2 transition-all duration-200 ${index === currentSlide
